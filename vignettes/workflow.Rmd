...
```{r}
df_moran <- read_csv("vignettes/expanded1/bin_analyses/df_moran.csv")
```
...
sfes <- readBins("vignettes/expanded1/bin_analyses", sides = sides)
...
```{r}
df_lee <-readLeeSamples("vignettes/expanded1/bin_analyses", cutoff = 0.2)
```
