...
- [`Piezo1TxSpots()`](Piezo1-download.md)
  ...
  [`Piezo1BinAnalyses()`](Piezo1-download.md)
  [`Piezo1Xenium()`](Piezo1-download.md) : Download Xenium data from Xue
  et al.
...
- [`getMoranMeanVar()`](getMoranMeanVar.md) : Get the mean and variance
  of Moran's I
- [`getPredCurves()`](getPredCurves.md) : Get fitted curves per group
- [`makeAggregates()`](makeAggregates.md) : Aggregate transcript spots
  into bins of varying sizes
- [`makeMonteCarlo()`](makeMonteCarlo.md) : Create Monte Carlo
  simulations with no spatial structure
...
- [`plotWpca()`](plotWpca.md) : Plot projections of genes/gene pairs in
  Wpca space
- [`plotWpcaLoadings()`](plotWpcaLoadings.md) : Plot Wpca loadings
...
- [`runAnova()`](runAnova.md) : Perform ANOVA to find whether spatial
  metric is associated with scale and group
...
- [`runBinLMM()`](runBinLMM.md) : Use linear mixed model to compare
  among groups
- [`runWpca()`](runWpca.md) : Run weighted PCA on fitted curves per
  stage
